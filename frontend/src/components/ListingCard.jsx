...
export default function ListingCard({ listing, onUpdate }) {
  ...
  const isMyClaim =
    user && listing.claimedBy && listing.claimedBy._id === user._id;
    ...
    <div className={`listing-card ${listing.status}`}>
      <div
        ...
        <div
          ...
          <div style={{ fontSize: 28, lineHeight: 1, flex: "none" }}>
            {emoji}
          </div>
          <div>
      ...
      <div
        ...
        {listing.claimedBy && (
          <div className="meta">
            🚴 Claimed by: <strong>{listing.claimedBy.name}</strong>
          </div>
        )}
      </div>
